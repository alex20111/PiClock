...
public class WeatherForecastViewOld extends JPanel implements PropertyChangeListener {
	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = Logger.getLogger( WeatherForecastViewOld.class.getName() );
	 ...
	 * Create the frame.
	 */
	public WeatherForecastViewOld(final JPanel cardsPanel) {
